...
import { applyGadgetOpenArgsUpdate, applyMovePatch, applyRectPatch, applyWindowEventProcUpdate, applyWindowEventUpdate, applyWindowOpenArgsUpdate, applyWindowPropertyUpdate, applyWindowRectPatch } from "../src/core/emitter/patchEmitter";
